...
<div class="container-fluid header-img">
	...
	<option value="">-- Select --</option><optgroup title="Nanded" label="&raquo; Nanded"></optgroup><option value="Nanded" >Nanded</option><option value="Ardhapur" >Ardhapur</option><option value="Bhokar" >Bhokar</option><option value="Biloli" >Biloli</option><option value="Dharmabad" >Dharmabad</option></select>
							</div>
